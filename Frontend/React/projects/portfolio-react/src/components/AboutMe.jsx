    ...
    <div className="w-full py-20 px-8" id="about">
      <div className="w-full flex flex-col justify-center items-center  gap-8">
        <div className="w-full flex items-center gap-4 justify-center">
          <h1 className="text-blue-400 text-3xl md:text-4xl mask-b-from-60% text-shadow-sm/30 text-shadow-zinc-600">Juan Agudelo</h1>
        ...
        >
          <a
            ...
            className="relative px-4 py-2 border border-black bg-white sm:bg-transparent sm:border-transparent  overflow-hidden group cursor-pointer rounded-md text-xs font-bold tracking-normal mask-b-from-40%"
            target="_blank"
          >
          ...
          <a
            ...
            className="relative px-4 py-2 border border-black bg-white mask-b-from-40% sm:bg-transparent sm:border-transparent  overflow-hidden group cursor-pointer rounded-md text-xs font-bold tracking-normal"
            target="_blank"
          >
            <span className="absolute inset-0 -translate-x-full group-hover:translate-x-0 bg-white   transition-transform duration-400 rounded-md"></span>
            <span className="relative z-10 text-blue-500 transition-colors duration-400  capitalize">
